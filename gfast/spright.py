...
from archive.gfast_rand import dec_to_bin, bin_to_dec, qary_vec_to_dec, binary_ints, qary_ints
from archive.gfast_rand import compute_delayed_wht, compute_delayed_gwht, get_Ms, get_b, get_D
from archive.gfast_rand import singleton_detection
...
if __name__ == "__main__":
    np.random.seed(10)
    from archive.gfast_rand import Signal
