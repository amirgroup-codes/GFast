...
if __name__ == '__main__':
    ...
    for i in range(args.iters):
        ...
        for removal in removal_policies:
            ...
            base_dir = Path(f'../synt_results/q{q}_n{n}_{removal}_S{sparsity}_snr{args.snr}_nr/')
            if removal == 'random':
                all_qs = [get_qs_from_delta_random(delta, q, n) for delta in args.delta]
    ...
    df.to_csv(f'../synt_results/q{q}_n{n}_results_S{sparsity}_snr{args.snr}_nr.csv')
